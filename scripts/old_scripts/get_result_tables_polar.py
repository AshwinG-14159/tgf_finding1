...
#         plt.plot(x_vals, frequencies[:,quads, threshold])
#         plt.title(f'thresh = {(threshold*10)+90}, quads = {quads+1}')
#         plt.xticks(x_vals, names_of_regions)
#         plt.savefig(f'figs/variation_{(threshold*10)+90}_{quads+1}_ver4.png')
#         plt.cla()
